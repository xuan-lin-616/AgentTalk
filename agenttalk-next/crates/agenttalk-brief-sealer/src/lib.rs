...
//! CAS boundary. Step 5 (journal Run creation) remains outside this crate:
//! Core invokes the storage journal only after a successful seal. The product
//! of this crate is [`sealer::PreparedBriefSeal`], which is immutable and is
//! **not** an OrchestrationRun and must not be passed to the scheduler
//! directly.
//!
